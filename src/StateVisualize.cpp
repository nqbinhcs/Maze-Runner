#include "StateVisualize.hpp"

//@DESCR: Initialize variables of StateVisualize
//@PARAM: None
//@RETURN: None
void StateVisualize::initVariables()
{
}


//@DESCR: Initialize parameter of StateVisualize's screen
//@PARAM: None
//@RETURN: None
void StateVisualize::initWindow()
{
	//Init window
...
//@PARAM: None
//@RETURN: None
void StateVisualize::initButtons()
{
...
//@PARAM: None
//@RETURN: None
void StateVisualize::initText()
{
	initTitle();
	initAlgorithmInfo();
}

//@DESCR: Constructor of StateVisualize
//@PARAM: None
//@RETURN: None
...
//@DESCR: Check whether the StateVisualize is running
//@PARAM: None
//@RETURN: the state of the game: FALSE - ended | TRUE - running
const bool StateVisualize::running() const
{
...
//@PARAM: None
//@RETURN: None
void StateVisualize::pollEvents()
{
	sf::Event temp;
...
//@DESCR: Render StateVisualize's state
//@PARAM: None
//@RETURN: None
void StateVisualize::render()
{
...
//@DESCR: Render StateVisualize's particular state such as: GameOver, NextStage, LevelComplete
//@PARAM: None
//@RETURN: None
void StateVisualize::renderDisplayStates(StatesInDemo state)
{
...
void StateVisualize::initAlgorithmInfo() {
	// Algorithm title
...
void StateVisualize::updateAlgorithmInfo() {
